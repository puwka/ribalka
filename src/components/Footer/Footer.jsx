      ...
      <div className="footer__container">
        ...
        <div className="footer__column">
          ...
          <ul>
            ...
            <li><a href="/paid-waters" onClick={(e) => onFooterClick(e, '/paid-waters')}>Платные базы</a></li>
            <li><a href="/paid-fishing" onClick={(e) => onFooterClick(e, '/paid-fishing')}>Платная рыбалка</a></li>
