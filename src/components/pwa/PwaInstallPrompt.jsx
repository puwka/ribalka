...
const DISMISS_MS = 90 * 24 * 60 * 60 * 1000; // 90 дней после «Позже»
const RESHOW_MS = 14 * 24 * 60 * 60 * 1000; // не чаще раза в 14 дней
...
export default function PwaInstallPrompt() {
  ...
  useEffect(() => {
    if (isStandalone() || !shouldOffer()) return undefined;
    ...
    if (isIos && isSafari) wantIos = true;
