  ...
  return (
    <section className="dir-pricing" style={{ marginTop: '1.5rem' }}>
      <header className="dir-pricing__head">
        ...
        <p>
          {isUpgrade
            ? `Доплата без продления срока: увеличьте число фото/видео (+${formatRub(ctor.addonPhoto)} / +${formatRub(ctor.addonVideo)}) или включите рамку. ТОП на сутки докупается отдельно кнопкой «Докупить ТОП».`
            : 'Выберите срок и доп. опции — стоимость считается сразу. ТОП на сутки можно взять здесь или докупить отдельно позже (как фото), без продления тарифа.'}
        </p>
      </header>
