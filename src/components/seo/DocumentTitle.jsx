...
const ROUTE_META = {
  ...
  '/reports': {
    title: 'Отчёты об активном отдыхе в Пермском крае',
    description: 'Рыбалка, охота и отдых в Перми и Пермском крае — отчёты с мест.',
  },
  '/forum': {
    title: 'Егорыч — помощник по рыбалке в Прикамье',
    description:
      'Спроси Егорыча, куда съездить на рыбалку, где купить червей или на что ловить — подскажет базы и магазины с сайта.',
  },
};
...
function matchMeta(pathname) {
  ...
  if (pathname.startsWith('/reports/')) {
    return {
      title: 'Отчёт об активном отдыхе — Пермский край',
      description: 'Отчёт о рыбалке, охоте или отдыхе в Перми и Пермском крае.',
    };
  }
  return {
